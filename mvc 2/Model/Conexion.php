...
class Conexion{
    ...
    public function insertUser($username, $nombre, $password, $email, $rol){
        $query = $this->con->query("INSERT INTO `usuarios` VALUES (NULL, '$username', '$nombre', '$email', '$password', $rol, NULL)");
